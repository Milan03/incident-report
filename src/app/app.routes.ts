...
import { StepPreparedByComponent } from './steps/step-prepared-by/step-prepared-by';
...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'people', component: StepPeopleComponent },
            {
                ...
                component: StepImmediateActionsComponent,
            },
            {
                path: 'follow-up-actions',
                component: StepFollowUpActionsComponent,
            },
            { path: 'prepared-by', component: StepPreparedByComponent },
